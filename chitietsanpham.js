...
window.onload = function () {
    ...
    var tags = ["Omron", "Sagami", "Lucass", "Serenefife", "Hapaku"];
...
function phanTich_URL_chiTietSanPham() {
    ...
    var s = addThongSo('Chất liệu', sanPhamHienTai.detail.q);
    s += addThongSo('Tải trọng tối đa', sanPhamHienTai.detail.ư);
    s += addThongSo('Kích thước', sanPhamHienTai.detail.e);
    s += addThongSo('Sản xuất tại', sanPhamHienTai.detail.r);
    s += addThongSo('Xuất xứ thương hiệu', sanPhamHienTai.detail.t);
    s += addThongSo('Bảo hành', sanPhamHienTai.detail.y);
    s += addThongSo('Trọng lượng sản phẩm', sanPhamHienTai.detail.u);
    s += addThongSo('Kính sử dụng', sanPhamHienTai.detail.i);
    s += addThongSo('Đối tượng sử dụng', sanPhamHienTai.detail.o);
    info.innerHTML = s;
